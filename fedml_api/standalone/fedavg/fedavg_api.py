...
class FedAvgAPI(object):
    ...
    def train(self):
        w_global = self.model_trainer.get_model_params()  #Get weight of all parameters of each layer
        w_per_mdls = []  #Save original weights of each params
        # 初始化
        for clnt in range(self.args.client_num_in_total):
            w_per_mdls.append(copy.deepcopy(w_global))  #Append original weight of each clients
